...
from sp.prophesee.coco_eval import evaluate_detection
...
def evaluate_list(
    ...
    if apply_bbox_filters:
        ...
        def filter_boxes_fn(boxes):
            return filter_boxes(boxes, skip_ts=skip_ts, min_box_diag=min_box_diag, min_box_side=min_box_side)
